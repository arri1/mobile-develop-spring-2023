...
const GraphQl = () => {
    ...
    const ContinentItem = ({ countries }) => {
      ...
      return (
        <Pressable style={{justifyContent:"center", alignItems:"center", height: 50, marginBottom: 30, backgroundColor: '#ffffff', borderRadius: 10}}>
          <Text>{name}</Text>
        </Pressable>
      );
    };
    ...
    return (
        <FlatList
            data={data.countries}
            contentContainerStyle={{padding:30, backgroundColor: "#E6F2FE"}}
